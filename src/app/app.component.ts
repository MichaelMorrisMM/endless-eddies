...
export class AppComponent implements OnInit, OnDestroy {
    ...
    private onLogInSubscription: ISubscription;
    private onLogOutSubscription: ISubscription;

    constructor(public authService: AuthService) {
    }

    ngOnInit() {
        this.onLogInSubscription = this.authService.onLogIn.subscribe((user: User) => {
            this.menuItemsArray = [
